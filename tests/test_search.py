...
from src.search import count_operations_by_category, filter_operations
...
def test_filter_operations_with_nested_lists():
    ...
    operations = [
        {"id": 1, "items": [{"name": "item1", "value": "A"}, {"name": "item2", "value": "B"}]},
        {"id": 2, "items": [{"name": "item3", "value": "C"}]},
    ]
...
def test_filter_operations_with_non_string_values():
    ...
    operations = [{"id": 1, "number": 12345, "flag": True}, {"id": 2, "number": 67890, "flag": False}]
...
def test_multiple_categories(sample_operations_count):
    ...
    result = count_operations_by_category(sample_operations_count, ["Перевод", "вклада", "магазине"])
    assert result == {
